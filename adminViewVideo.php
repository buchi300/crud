                        ...
                        <div class="col-md-4 mb-3 ">
                            <div class="card" style="width: 24rem;">
                                <div class="card-body mx-auto">
                                    ...
                                    <source src="assets/video/<?php echo $row["id"].".mp4"?>" type="video/mp4">
                                    <!-- <source src="movie.ogg" type="video/ogg"> -->
                                    Your browser does not support the video tag.
                                    </video>
                                    </p>
                                    <a href="adminEditVideo.php?id=<?php echo $row["id"]?>" class="btn btn-primary">EDIT</a>
                                    <a href="adminDeleteVideo.php?id=<?php echo $row["id"]?>" class="btn  btn-primary">Delete</a>
                                </div>
                            </div>
                        </div>
